...
# True_sd_L <- c(seq(from=0.2,to=0.45,by=0.05),
#                seq(from=0.5,to=0.9,by=0.1),
#                1,
#                seq(from=1.2,to=2,by=0.2),
#                seq(from=2.5,to=5,by=0.5))
...
for (M2 in 41:60){
  ...
  for (S2 in 1:length(True_sd_L)) {
    ...
    Filename <- paste0("SDI_",True_mean_L[M2]/True_mean_S[M1]-1,
                       "_SD_S_",True_sd_S[S1],
                       "_SD_L_",True_sd_L[S2],
                       "_Ratio_",Pop_ratio[PR],
                       ".xlsx")
