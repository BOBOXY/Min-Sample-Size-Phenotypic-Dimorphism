...
for (M2 in 37:48){
  ...
  for (SK in 1:length(Skewness_gamma_1)) {
    ...
    root_1 <- try(uniroot(Function_skewness_alpha,
                          tol = 0.000000000001,
                          skewness_gamma_1 = Skewness_gamma_1[SK],
                          interval = c(-10,10)))
    alpha_1 = root_1$root
    ...
    root_2 <- try(uniroot(Function_skewness_alpha,
                          tol = 0.000000000001,
                          skewness_gamma_1 = Skewness_gamma_2[SK],
                          interval = c(-10,10)))
    alpha_2 = root_2$root
    ...
    Filename <- paste0("DI_",round(True_mean_L[M2]/True_mean_S[M1]-1,3),
                       ...
                       "_Skew_S_",round(Skewness_gamma_1[SK],3),
                       "_Skew_L_",round(Skewness_gamma_2[SK],3),
                       ".xlsx")
